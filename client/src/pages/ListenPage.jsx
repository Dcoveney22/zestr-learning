...
export default function ListenPage() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: s.cream, ...s.sans }}>

      {/* ── NAV ── */}
      <nav
        className="sticky top-0 z-10 px-5 py-4 flex items-center gap-3"
        style={{ backgroundColor: "white", borderBottom: `1px solid ${s.border}` }}
      >
        <button
            ...
            {episode.audio_url ? (
              <>
                ...
                <audio
                  ...
                  onEnded={() => { setPlaying(false); markListened(); }}
                />
                ...
                {/* Time */}
                <div className="flex justify-between text-xs mb-6" style={{ color: s.muted }}>
                ...
                <div className="flex items-center justify-center gap-6">
                  ...
                  >
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      ...
                      <text x="8" y="14" fontSize="6" fill="currentColor" stroke="none" fontWeight="600">15</text>
                    </svg>
                    <span className="text-xs" style={{ fontWeight: 300 }}>15s</span>
                  </button>
              ...
              <div className="text-center py-4">
                <p className="text-sm mb-2" style={{ color: s.charcoal, fontWeight: 500 }}>
                  Audio coming soon
                </p>
                <p className="text-xs" style={{ color: s.muted, fontWeight: 300 }}>
            ...
            <div className="space-y-3">
              {episode.transcript_url && (
                ...
                >
                  ...
                  >
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={s.sage} strokeWidth="2">
